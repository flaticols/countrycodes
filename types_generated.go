...
// Country represents complete country information aggregated from ISO 3166 and UN M.49 data sources.
// All fields are pre-populated at compile-time for zero-allocation access.
type Country struct {
